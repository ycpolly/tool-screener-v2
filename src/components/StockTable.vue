  ...
  <div class="stock-table-container space-y-3">
    ...
    <div class="flex flex-wrap items-center justify-between gap-2 px-1 text-xs text-base-content/70">
      <div class="flex items-center gap-3">
        ...
        <span v-if="formattedUpdatedAt" class="text-base-content/50 font-numeric">
      ...
      <div class="flex items-center gap-1 font-medium">
        ...
        >
          <span>{{ opt.label }}</span>
          <span v-if="currentSortKey === opt.key" class="ml-0.5 font-numeric text-[10px]">
            {{ currentSortDir === 'desc' ? '▼' : '▲' }}
          </span>
        </button>
      </div>
    ...
    >
      <div class="text-base-content/40 text-sm font-medium">
