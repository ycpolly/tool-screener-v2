...
export const UI_STRINGS = {
  ...
  SCREENER: {
    ...
    unmatchedReasonPrefix: '未達標：',
    unmatchedSummary: (n, reasons) => `${n} 項未達標：${reasons}`,
    shortFailLabels: {
      '均線支撐': '未站穩 5MA',
      '季線防身': '未站上季線',
      '5MA 乖離': '5MA 乖離超標',
  ...
  PANEL: {
    ...
    moduleVol: '量能與流動性',
    maSupport: '支撐',
    maAboveBoth: '(嚴) 站穩 5 與 10',
    maAboveAny: '(寬) 站穩 5 或 10',
    maAbove5ma: '(寬) 站上 5',
    maAboveNone: '無限制',
    ma20Rising: '20MA 斜率向上 (今日 > 昨日)',
    convergence: '當日三線價差',
    ...
    excludeSell3D: '排除外資 / 主力 / 投信連 3 日賣超 (含 50 豁免)',
  ...
  DIAGNOSIS_LABELS: {
    ...
    bias20: '月線乖離',
    convergence: '三線糾結',
    prevConvergence: '昨日糾結',
    ma20Slope: '月線斜率',
    volume: '成交量能',
    volExpansion: '量能攻擊',
    volPullback: '量縮回踩',
    prevVolContraction: '昨日量縮',
    volContraction: '量縮洗盤',
    redCandle: '實體紅 K',
    tightConsolidation: '狹幅打底',
    upperShadow: '上影線',
    avoidLongBlack: '長黑避雷',
    kdMomentum: 'KD 動能',
    chipsSell3D: '籌碼避雷',
  ...
  FILTER_REASONS: {
    ...
    avoidUpperShadowFailed: '觸發避雷針型態 (上影線長度超過實體紅 K 0.3 倍)',
