...
> **最後更新：2026-08-31**（完成一鍵精選即時全模式連動、全站按鈕 Design System 方形微圓角統一、排序按鈕修復、籌碼透視區塊純文字流）
...
- [x] 後端兩波流更新排程（17:00 第一批選股名單與大盤燈號更新；19:00 第二批券商分點出爐，注入籌碼集中度與短沖避雷數據）— 完成 2026-08-31
- [x] StockCard UI 集中度標籤與短沖避雷警示列渲染（手機/電腦雙端響應式）— 完成 2026-08-31
