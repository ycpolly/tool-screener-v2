...
### Phase 3（完整功能）
- [x] 五大選股模式定義（底部蓄勢、多頭回測、動能攻擊、多頭起漲、跌深反轉）— 完成 2026-08-31
...
- [x] 全市場時光機回測引擎（支援近 0~5 個交易日歷史切片 `sliceStockAt`、開盤交易日 `isLiveTradingDay` 智慧即時與歷史對位、動態推算歷史 `vMa5` 與 `history10d` 內建 `ma60` 季線）— 完成 2026-08-31
